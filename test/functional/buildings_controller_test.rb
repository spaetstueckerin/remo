...
class BuildingsControllerTest < ActionController::TestCase
  ...
  test "should create building" do
    assert_difference('Building.count') do
      post :create, building: { description: @building.description, name: @building.name, site_id: @building.site_id }
    end
  ...
  test "should update building" do
    put :update, id: @building, building: { description: @building.description, name: @building.name, site_id: @building.site_id }
    assert_redirected_to building_path(assigns(:building))
  end
