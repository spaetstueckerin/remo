...
class ProductionsControllerTest < ActionController::TestCase
  ...
  test "should create production" do
    assert_difference('Production.count') do
      post :create, production: { productRange_id: @production.productRange_id, productedUnits: @production.productedUnits, year: @production.year }
    end
  ...
  test "should update production" do
    put :update, id: @production, production: { productRange_id: @production.productRange_id, productedUnits: @production.productedUnits, year: @production.year }
    assert_redirected_to production_path(assigns(:production))
  end
